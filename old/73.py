"""
Polyhedron Shader v0.73

This program shades convex polyhedra.
Polyhedra are now tested to remove all nonexistent faces, such as nonagons,
to remove all types of faces with an odd number of members, and to remove
all types of faces with a small number of members relative to the total.
"""
