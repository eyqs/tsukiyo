"""
Polychoron Visualizer v0.37

This script displays the regular polyhedra and the hypercube.
The hypercube can now rotate about the xy-axis-plane.
"""
...
TITLE = "Polychoron Visualizer v0.37"
DESCRIPTION = "\nThis script displays the regular polyhedra and the hypercube."
pi = math.pi
WIDTH = 500
HEIGHT = 450
...
DATA = [[RADIUS]*16,
        [pi/4]*4+[3*pi/4]*4+[5*pi/4]*4+[7*pi/4]*4,
        [0.9553166, 0.9553166, 2.186276, 2.186276]*4,
        [pi/3, 2*pi/3]*8,
        [(0,1),(0,2),(0,12),(0,4),
         (1,3),(1,5),(1,13),
         (2,3),(2,6),(2,14),
...
class Canvas(tk.Canvas):
    ...
    def _view(self, points):
        ...
        while count < num:
            ...
            z = points[count][2]
            w = points[count][3]
            t = (l-x*u[0]-y*u[1]-z*u[2]-w*u[3])/(d-x*u[0]-y*u[1]-z*u[2]-w*u[3])
...
class Polytope():
    ...
    def __init__(self, data):
        ...
        if data:
            ...
            self._edges = [(0, 1), (1, 3), (3, 2), (2, 0), (4, 5), (5, 7), (7, 6), (6, 4),
                           (8, 9), (9, 11), (11, 10), (10, 8), (12, 13), (13, 15), (15, 14), (14, 12),
                           (0, 4), (1, 5), (2, 6), (3, 7), (8, 12), (9, 13), (10, 14), (11, 15),
                           (0, 8), (1, 9), (2, 10), (3, 11), (4, 12), (5, 13), (6, 14), (7, 15)]
            self.x = [100, -100, 100, -100, 100, -100, 100, -100, 100, -100, 100, -100, 100, -100, 100, -100]
            self.z = [100, 100, 100, 100, -100, -100, -100, -100, 100, 100, 100, 100, -100, -100, -100, -100]
            self.y = [100, 100, -100, -100, 100, 100, -100, -100, 100, 100, -100, -100, 100, 100, -100, -100]
            self.w = [100, 100, 100, 100, 100, 100, 100, 100, -100, -100, -100, -100, -100, -100, -100, -100]
        elif not data:
            self._number = 0
            self._edges = []
            self.x = []
    ...
    def get_points(self):
        ...
        while n < self._number:
            points.append((self.x[n], self.y[n], self.z[n], self.w[n]))
            n += 1
        return points
    ...
    def rotate(self, rotAngle):
        ...
        n = 0
        while n < self._number:
            p = (self.x[n], self.y[n], self.z[n], self.w[n])
