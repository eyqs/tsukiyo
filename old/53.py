"""
Schwarz Visualizer v0.53

This program displays polyhedra based on their Wythoff symbol.
All Schwarz triangles, not just Mobius triangles, now work.
Many symbols are missing vertices, like (2 | 7/2 2) and (4 3/2 | 4).
"""
...
TITLE = 'Schwarz Visualizer v0.53'
