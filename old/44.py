"""
Wythoff Visualizer v0.44

This script displays the tetrakis hexahedron.
This also shows the top and bottom caps of all Mobius triangle coverings.
"""
...
TITLE = "Wythoff Visualizer v0.44"
...
class Canvas(tk.Canvas):
    ...
    def _wythoff(self, entry):
        ...
        pPhi = math.acos(math.cos(pi/q)/math.sin(pi/s))
        qPhi = math.acos(math.cos(pi/q)*math.cos(pi/s)/
                         math.sin(pi/q)/math.sin(pi/s))

        # Triangles of the first and last rings
        for k in range(s):
            triangles += [((0,0), (2*pi*k/s, pPhi),
                           (2*pi*k/s + pi/s, qPhi)),
                          ((0,0), (2*pi*k/s, pPhi),
                           (2*pi*k/s - pi/s, qPhi)),
                          ((0,pi),(2*pi*k/s - pi/s, pi-pPhi),
                           (2*pi*k/s, pi-qPhi)),
                          ((0,pi),(2*pi*k/s + pi/s, pi-pPhi),
                           (2*pi*k/s, pi-qPhi))]
