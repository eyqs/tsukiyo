"""
Polygon Visualizer v0.13

This script attempts to rotate polygons in eD.
However, it merely shrinks them instead of rotating them.
This program stores polygon data in spherical coordinates.
"""
...
TITLE = "Polygon Visualizer v0.13"
