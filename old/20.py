...
TITLE = "Polyhedron Visualizer v0.20"
...
class Canvas(tk.Canvas):
    ...
    def _schlafli3D(self, entry):
        ...
        # Formula derived from 14/09/18 to 14/09/20
    ...
    def _render(self):
        ...
        if self.currPolytope.get_edges():
            ...
            for edge in edges:
                self.create_line(points[edge[0]], points[edge[1]], fill='#000')
