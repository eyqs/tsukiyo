"""
Polyhedron Shader v0.58

This program shades simple polygons monochromatically.
Shaded polygons now replace edges with faces, which fulfill the same function.
Edges stored unordered collections of edges in one list: [(), (), (), (), ...]
Faces store closed loops of edges: [((), (), ()), ((), (), ()), ((), ...), ...]
"""
    ...
    def _render(self):
        ...
        if SHADING == True:    # Display polytope by drawing polygons
            if self._currPolytope.get_faces():
                ...
                for face in faces:
                    edges = [points[side[0]] for side in face]
