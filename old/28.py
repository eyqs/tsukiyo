"""
Polyhedron Visualizer v0.28

This script displays the regular polyhedra, except the dodecahedron.
Any view can now be selected from any distance.
"""
...
TITLE = "Polyhedron Visualizer v0.28"
...
class Canvas(tk.Canvas):
    ...
    def _translate(self, entry):
        ...
        # Set polyhedron radius
            ...
            self._radius = entry[1:]

        # Set projection distance
        elif entry.startswith("d"):
            if entry.lower() == ("dinf" or "dinfinity"):
                self._infinity = True
            elif float(entry[1:]) > 20:
                self._infinity = True
            else:
                self._infinity = False
