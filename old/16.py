"""
Polygon Visualizer v0.16

This script rotates polygons about the x- and z-axes.
It also allows you to change your current viewing position.
"""
...
TITLE = "Polygon Visualizer v0.16"
...
class Main(ttk.Frame):
    ...
    def _initUI(self):
        ...
        self._statusLabel.grid(row=0, column=0, columnspan=4, sticky=tk.W)
