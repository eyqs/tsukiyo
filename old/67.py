"""
Polyhedron Shader v0.67

This program shades convex polyhedra.
Relative light intensities are calculated with Lambert's cosine law,
thought to be an original idea until it was recalled from search history.
All face data (_faces, _centres, _colours) are now dictionaries.
"""
...
class Polytope():
    ...
    def _set_faces(self, edges):
        ...
        self._faces = {}
        self._facesides = {i:0 for i in range(3,11)}
        self._visited = set()
        self._triangles = set()
    ...
    def shade_faces(self, viewAxis):
        ...
        for face in self._faces:
            ...
            for i in range(3):  # Lambert's cosine law for diffuse reflectors
                shade = self._base_colours[face][i] # Positive, but not brighter
