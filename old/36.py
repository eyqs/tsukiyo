"""
Polychoron Visualizer v0.36

This script displays the regular polyhedra and the hypercube.
The hypercube is displayed with projection from any axis.
"""
...
TITLE = "Polychoron Visualizer v0.36"
DESCRIPTION = "\nThis script displays the regular polyhedra and the hypercube."
pi = math.pi
WIDTH = 500
HEIGHT = 450
...
class Polytope():
    ...
    def get_axes(self):
        ...
        axis = (math.sin(self._axis_omega)*math.sin(self._axis_phi)*math.cos(self._axis_theta),
                math.sin(self._axis_omega)*math.sin(self._axis_phi)*math.sin(self._axis_theta),
                math.sin(self._axis_omega)*math.cos(self._axis_phi),
                math.cos(self._axis_omega))
