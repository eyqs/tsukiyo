"""
Wythoff Visualizer v0.42

This script displays the double pyramids.
These double prisms have the Wythoff symbol (2 2 s).
"""
...
TITLE = "Wythoff Visualizer v0.42"
...
class Canvas(tk.Canvas):
    ...
    def _wythoff(self, entry):
        ...
        if q == 2:
            for k in range(s):
                triangles += [((0,0),(2*pi*k/s,pi/2),(2*pi*k/s + pi/s,pi/2)),
                              ((0,0),(2*pi*k/s,pi/2),(2*pi*k/s - pi/s,pi/2)),
                              ((0,pi),(2*pi*k/s,pi/2),(2*pi*k/s + pi/s,pi/2)),
                              ((0,pi),(2*pi*k/s,pi/2),(2*pi*k/s - pi/s,pi/2))]
        elif q == 3:
            if s == 3:
                pass
