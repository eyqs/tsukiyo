"""
Polyhedron Shader v0.65

This program shades convex polyhedra.
The centres of each face is stored and the distance between the viewPoint and
the centres is sorted to display each face in the correct order. However,
the centres of inside faces often go in front of the centres of outside faces.
"""
