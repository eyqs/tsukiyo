"""
Polyhedron Shader v0.64

This program shades polyhedra without regards to camera position.
The breadth-first search now returns a list of up to two faces per edge,
and only faces with all unvisited edges are returned, eliminating double faces.
The Schläfli dodecahedron vertices are correct and sides are joined properly now.
"""
