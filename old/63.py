"""
Polyhedron Shader v0.63

This program shades polyhedra without regards to camera position.
The breadth-first search first runs the loop for triangles, which do not have
enough sides to find pathEnd and can be expressed without regards to order.
The algorithm runs fast, but has some double faces and inside 'faces' too.
"""
