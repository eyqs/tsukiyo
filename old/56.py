"""
Schwarz Visualizer v0.56

This program displays polyhedra based on their Wythoff symbol.
All Wythoff symbols are now correctly processed, including snubs,
which are generated by random sampling and optimization.
However, this randomness often leads to unwanted local minima.
"""
...
TITLE = 'Schwarz Visualizer v0.56'
