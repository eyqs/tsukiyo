"""
Polyhedron Shader v0.72

This program shades convex polyhedra.
Edges are now tested for coplanarity, which doubles the time taken for most
polyhedra which render within 0.1 s, but it halves the time taken to 0.5 s for
(| 2 3 5), (| 2 5/3 3), etc. All rotations can now be set, not only basis planes.
"""
